...
interface HypervisorFactoryInterface extends ethers.utils.Interface {
  functions: {
    ...
    "getHypervisors()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "getHypervisors",
    values?: undefined
  ): string;
...
export class HypervisorFactory extends BaseContract {
  ...
  functions: {
    ...
    getHypervisors(overrides?: CallOverrides): Promise<[string[]]>;
  ...
  estimateGas: {
    ...
    getHypervisors(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    getHypervisors(overrides?: CallOverrides): Promise<PopulatedTransaction>;
