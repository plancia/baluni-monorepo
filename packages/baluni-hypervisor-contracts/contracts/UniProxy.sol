...
contract UniProxy is ReentrancyGuard {
    ...
    function deposit(
        ...
        shares = IHypervisor(pos).deposit(
            deposit0,
            deposit1,
            to,
            msg.sender,
    ...
    function addPosition(address pos, uint8 _version) external onlyOwner {
        IClearing(pos).addPosition(pos, _version);
    }
}
