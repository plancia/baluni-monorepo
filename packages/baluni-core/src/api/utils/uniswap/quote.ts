...
import * as uniswapV3FactoryAbi from '../../abis/uniswap/Factory.json'
import * as uniswapV3PoolAbi from '../../abis/uniswap/Pool.json'
import * as erc20Abi from '../../abis/common/ERC20.json' // Assuming you have ERC20 ABI for fetching decimals
