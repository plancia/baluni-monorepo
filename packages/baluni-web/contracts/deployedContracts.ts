...
// import { baluniContracts } from 'baluni-contracts/src';
// import { baluniContracts } from 'baluni-contracts';
// import { baluniHypervisorContracts } from 'baluni-hypervisor-contracts';
...
const deployedContracts = {
  137: {
    ...
    BaluniHypervisorFactory: {
      address: (hyperContracts[137] as any).BaluniV1HyperFactory,
      abi: HypervisorFactoryAbi.abi,
    },
    BaluniHyperPool_WMATICxUSDC: {
      address: (hyperContracts[137] as any).BaluniHyperPool_WMATICxUSDC,
      abi: HypervisorAbi.abi,
    },
    BaluniHypeAdmin: {
      address: (hyperContracts[137] as any).BaluniV1HyperAdmin,
      abi: HyperAdminAbi.abi,
    },
    BaluniHyperAutoRebal: {
      address: (hyperContracts[137] as any).BaluniV1HyperAutoRebal,
      abi: HyperAutoRebalAbi.abi,
    },
    BaluniHyperClearingV2: {
      address: (hyperContracts[137] as any).BaluniV1HyperClearingV2,
      abi: HyperClearingAbi.abi,
    },
    BaluniUniProxy: {
      address: (hyperContracts[137] as any).BaluniV1HyperUniProxy,
      abi: uniProxyAbi.abi,
    },
  },
