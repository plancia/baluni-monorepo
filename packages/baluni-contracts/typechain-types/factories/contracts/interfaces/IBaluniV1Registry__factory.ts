...
import type {
  IBaluniV1Registry,
  IBaluniV1RegistryInterface,
} from "../../../contracts/interfaces/IBaluniV1Registry";
...
export class IBaluniV1Registry__factory {
  static readonly abi = _abi;
  static createInterface(): IBaluniV1RegistryInterface {
    return new Interface(_abi) as IBaluniV1RegistryInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): IBaluniV1Registry {
    return new Contract(address, _abi, runner) as unknown as IBaluniV1Registry;
  }
}
