...
import type {
  IBaluniV1Router,
  IBaluniV1RouterInterface,
} from "../../../contracts/interfaces/IBaluniV1Router";
...
export class IBaluniV1Router__factory {
  static readonly abi = _abi;
  static createInterface(): IBaluniV1RouterInterface {
    return new Interface(_abi) as IBaluniV1RouterInterface;
  }
  static connect(
    address: string,
    runner?: ContractRunner | null
  ): IBaluniV1Router {
    return new Contract(address, _abi, runner) as unknown as IBaluniV1Router;
  }
}
