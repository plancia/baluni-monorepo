...
export interface I1inchSpotAggInterface extends Interface {
...
export interface I1inchSpotAgg extends BaseContract {
  connect(runner?: ContractRunner | null): I1inchSpotAgg;
  waitForDeployment(): Promise<this>;

  interface: I1inchSpotAggInterface;
  ...
  getRateToEth: TypedContractMethod<
    [srcToken: AddressLike, useWrappers: boolean],
    [bigint],
    "view"
  >;
