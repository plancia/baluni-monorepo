...
export interface BaluniV1DCAVaultRegistryInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface BaluniV1DCAVaultRegistry extends BaseContract {
  connect(runner?: ContractRunner | null): BaluniV1DCAVaultRegistry;
  waitForDeployment(): Promise<this>;

  interface: BaluniV1DCAVaultRegistryInterface;
