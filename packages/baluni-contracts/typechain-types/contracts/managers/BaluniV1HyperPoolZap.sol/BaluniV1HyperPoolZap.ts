...
export interface BaluniV1HyperPoolZapInterface extends Interface {
  getFunction(
    nameOrSignature:
  ...
  encodeFunctionData(
    functionFragment: "baluniHyperUniProxy",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "changeSwapper",
    values: [AddressLike]
  ): string;
  encodeFunctionData(
    functionFragment: "changeUniProxy",
    values: [AddressLike]
  ): string;
  encodeFunctionData(
...
export interface BaluniV1HyperPoolZap extends BaseContract {
  connect(runner?: ContractRunner | null): BaluniV1HyperPoolZap;
  waitForDeployment(): Promise<this>;

  interface: BaluniV1HyperPoolZapInterface;
  ...
  baluniHyperUniProxy: TypedContractMethod<[], [string], "view">;
  ...
  changeSwapper: TypedContractMethod<
    [_swapper: AddressLike],
    [void],
    "nonpayable"
  >;

  changeUniProxy: TypedContractMethod<
    [_uniProxy: AddressLike],
    [void],
    "nonpayable"
  >;

  initialize: TypedContractMethod<
    [_registry: AddressLike, _uniProxy: AddressLike],
    [void],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "baluniHyperUniProxy"
  ): TypedContractMethod<[], [string], "view">;
  getFunction(
  ...
  getFunction(
    nameOrSignature: "changeSwapper"
  ): TypedContractMethod<[_swapper: AddressLike], [void], "nonpayable">;
  getFunction(
    nameOrSignature: "changeUniProxy"
  ): TypedContractMethod<[_uniProxy: AddressLike], [void], "nonpayable">;
  getFunction(
