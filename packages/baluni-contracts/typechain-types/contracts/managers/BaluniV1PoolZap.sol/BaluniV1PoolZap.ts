...
export interface BaluniV1PoolZapInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface BaluniV1PoolZap extends BaseContract {
  connect(runner?: ContractRunner | null): BaluniV1PoolZap;
  waitForDeployment(): Promise<this>;

  interface: BaluniV1PoolZapInterface;
