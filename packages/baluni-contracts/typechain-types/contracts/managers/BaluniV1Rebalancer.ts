...
export interface BaluniV1RebalancerInterface extends Interface {
  getFunction(
    nameOrSignature:
...
export interface BaluniV1Rebalancer extends BaseContract {
  connect(runner?: ContractRunner | null): BaluniV1Rebalancer;
  waitForDeployment(): Promise<this>;

  interface: BaluniV1RebalancerInterface;
  ...
  checkRebalance: TypedContractMethod<
    ...
    [BaluniV1Rebalancer.RebalanceVarsStructOutput],
    "view"
  >;
